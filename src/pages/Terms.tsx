...
const Terms = () => {
  ...
  return (
    <PolicyLayout>
      <article className="prose prose-slate max-w-none"><div className="flex items-center gap-3 mb-6">
          <button
            onClick={() => navigate(-1)}
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <p>
            This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://shop.peonylifesciences.com/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
          </p>

          <p>
            The Platform is owned by Solai pharma agencies, a company incorporated under the Companies Act, 1956 with its registered office at No 20 51 NGGO Colony Pattukottai Thanjavur Tamil Nadu 614601 India (hereinafter referred to as "Platform Owner", 'we', 'us', 'our').
          </p>
          ...
          <p>
            All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Pattukkottai and Tamil Nadu.
          </p>
