    ...
    <PolicyLayout>
      <article className="prose prose-slate max-w-none">
        ...
        <div className="space-y-8 text-muted-foreground leading-relaxed">
          ...
          <section>
            <h3 className="text-lg font-medium text-foreground mb-3">Sharing</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-medium text-foreground mb-3">Security Precautions</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-medium text-foreground mb-3">Data Deletion and Retention</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-medium text-foreground mb-3">Consent</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-medium text-foreground mb-3">Changes to this Privacy Policy</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-medium text-foreground mb-3">Grievance Officer</h3>
            <div className="bg-secondary/50 rounded-lg p-4">
              <p><strong>Name:</strong> Suga Raja Varman</p>
              <p><strong>Designation:</strong> CMO</p>
              <p><strong>Company:</strong> Solai Pharma Agencies</p>
              <p><strong>Address:</strong> No 20 51 NGGO Colony Pattukottai Thanjavur Tamil Nadu 614601 India</p>
              <p><strong>Phone:</strong> +91 70109 66990</p>
